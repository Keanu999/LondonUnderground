...
// based on  Asymmetric Cryptography example found on https://mkyong.com/
...
public class GenerateKeys
{
    ...
    public static void createKeys(String privateKeyFile, String publicKeyFile)
    {
        try
        {
            ...
            gk.createKeys();
            gk.writeToFile(privateKeyFile, gk.getPrivateKey()
                                             .getEncoded());
            gk.writeToFile(publicKeyFile, gk.getPublicKey()
                                            .getEncoded());
        }
        catch (Exception ex)
        {
